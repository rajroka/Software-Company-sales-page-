...
const ContactPage = () => {
  return (
    <div className="w-screen flex flex-col min-h-screen  py-10  px-6 md:px-12 lg:px-24 bg-gradient-to-r  from-orange-100 via-purple-100 to-blue-100">
      <div className=" flex  items-center justify-center mt-10 mb-10 ">
        <h3 className="font-medium text-2xl  text-center  px-4 py-2   bg-[#1834E7] rounded-lg  font-serif text-white  inline-block ">
          Contact us{" "}
        </h3>
      </div>

      {/* Container */}
      <div className="w-full h-auto  flex flex-col md:flex-row items-center mx-auto mb-10     ">
        {/* Image Section */}
        ...
        <div className="   lg:w-1/2  px-8  pt-10 space-y-4   bg-white/80  backdrop-blur-sm   rounded-lg shadow-lg border border-white/20  ">
          ...
          <div>
            <h1 className="text-2xl font-bold mb-4 text-primary font-serif">
              Get in Touch
            </h1>
          ...
          <div className="flex flex-col">
            ...
            <span className="font-normal  text-base">rokaraaz@gmail.com </span>
          </div>
          <div className="flex flex-col">
            {" "}
          ...
          <div className="flex flex-col">
            ...
            <span className="text-base font-normal ">Pokhara ,Fulbari-11 </span>
          </div>
          <div>
            <Link href="/book">
              <button className="bg-[#1834E7] rounded p-2 text-white text-base  font-medium border-none">
                Book a appointment
              </button>
            </Link>
          </div>
